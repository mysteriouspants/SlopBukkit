TITLE Mixed-Mode FPU Arithmetic      (MixedMode.asm)

; Demonstrates mixed-mode arithmetic using reals and integers.
; Also demonstrates multiplication and division of reals, and
