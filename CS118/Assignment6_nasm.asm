...
%include "Along32.inc"
segment .data
	prompt db "Enter an integer, or zero to exit: ",0
	bye db "Bye!",0
	preconditionFail db "Failed precondition, must be greater than 1",0
	noprime db "Not prime, running time: ",0
	yesprime db "Is a prime, running time: ",0
	ctrlWord db ?
	startTime db ?
	endTime db ?
.code
