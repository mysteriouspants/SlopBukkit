...
rem  configuration used here assumes that you are using MASM Version 8 and
rem Visual Studio 2008 (or Visual C++ 2008 Express SP1).  This batch file runs
rem  under Windows XP and Windows Vista. Copyright Kip Irvine, 2007-2008. You 
rem  may freely use and modify this file as long as you do not remove the names of its authors.
rem                                                                    
...
rem  C:\Program Files\Microsoft Visual Studio 9.0, you must modify the 
...
rem   8/26/08: Revised for Visual Studio 2008
rem  --------------------------------------------------------------------
...
rem  Studio 2008 (or Visual C++ 2008 Express SP1)
rem -----------------------------------------------------------------
...
echo directory: C:\Program Files\Microsoft Visual Studio 9.0
echo.
...
echo the following directory: C:\Program Files\Microsoft Visual Studio 9.0\VC\bin
echo.
